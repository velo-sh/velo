...
| **D14**| MessagePack IPC: Upgrade Rust↔Python IPC from JSON to MessagePack. | [OPT-0010-001](../rfcs/OPT-0010-001-msgpack-ipc.md) | `src/zygote/ipc.rs`, `python/velo_zygote/` |
