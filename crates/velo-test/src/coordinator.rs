//! crate::VtestCoordinator - Orchestrates Zygote-accelerated test execution
//!
...
/// crate::VtestCoordinator - Manages Zygote-accelerated test execution
///
...
impl crate::VtestCoordinator {
    /// Create a new crate::VtestCoordinator
    ///
    /// # Arguments
    ...
    fn dispatch_via_ipc(&mut self, test_id: &str) -> Result<VtestResult> {
        ...
        let env = velo_core::lifecycle::EnvironmentShield::new(&self.config).compile_env();

        // Send RunTest command
        let response = velo_core::zygote::core_ipc::send_command(
            &self.socket_path,
            velo_core::zygote::core_ipc::ZygoteCommand::RunTest {
                test_id: test_id.to_string(),
        ...
        match response {
            velo_core::zygote::core_ipc::ZygoteResponse::TestComplete {
                worker_pid: _,
                test_id: returned_id,
                passed,
                exit_code,
            ...
            velo_core::zygote::core_ipc::ZygoteResponse::Error { message } => {
...
mod tests {
    ...
    fn test_coordinator_creation() {
        ...
        let coordinator = crate::VtestCoordinator::new(&config, 4, None);
        unsafe {
