...
SECURITY_BASE_TRUSTED_PREFIXES = "/usr,/bin,/sbin,/lib,/Library/Frameworks,/Library/Developer/CommandLineTools,${HOME}/eclipse-workspace/rust_source/velo_ci,${HOME}/Library/Python,${HOME}/.local/lib,${HOME}/.local/bin,${HOME}/.local/share/uv/python,${VIRTUAL_ENV}"
SECURITY_BASE_ENV_WHITELIST = "PATH,HOME,USER,LOGNAME,PWD,TMPDIR,PYTHONPATH,PYTHONHOME,LANG,LC_ALL,LC_CTYPE,TZ,TERM,MallocNanoZone,VELO_ENV,VELO_ZYGOTE_SOCKET,VELO_ZYGOTE_SOCKET_TIMEOUT,VELO_TIMEOUT_MULTIPLIER,VELO_STRICT_NUMA,VELO_ZYGOTE_SHIELD_ACTIVE,VELO_WORKER_DEBUG_LOG,VIRTUAL_ENV,CI,GITHUB_ACTIONS,__CFBundleIdentifier"
...
if sys.platform == "darwin":
    ...
    SECURITY_MACOS_DEV_ENV_WHITELIST = "${OS_BASE},SHELL,VIRTUAL_ENV,CONDA_PREFIX,DYLD_LIBRARY_PATH,DYLD_FALLBACK_LIBRARY_PATH"
