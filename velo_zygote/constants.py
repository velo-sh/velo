...
SECURITY_BASE_ENV_WHITELIST = "PATH,HOME,USER,TMPDIR,PYTHONPATH,LANG,LC_ALL,LC_CTYPE,TZ,TERM,MallocNanoZone,VELO_ENV,VELO_ZYGOTE_SOCKET,VELO_ZYGOTE_SOCKET_TIMEOUT,VELO_TIMEOUT_MULTIPLIER,VELO_STRICT_NUMA,VELO_ZYGOTE_SHIELD_ACTIVE,VIRTUAL_ENV,CI,GITHUB_ACTIONS"
