...
SECURITY_BASE_ENV_WHITELIST = "PATH,HOME,USER,LOGNAME,PWD,TMPDIR,PYTHONPATH,PYTHONHOME,LANG,LC_ALL,LC_CTYPE,TZ,TERM,MallocNanoZone,VELO_ENV,VELO_ZYGOTE_SOCKET,VELO_ZYGOTE_SOCKET_TIMEOUT,VELO_ZYGOTE_AUTH,VELO_TIMEOUT_MULTIPLIER,VELO_STRICT_NUMA,VELO_ZYGOTE_SHIELD_ACTIVE,VELO_WORKER_DEBUG_LOG,VIRTUAL_ENV,CI,GITHUB_ACTIONS,__CFBundleIdentifier"
