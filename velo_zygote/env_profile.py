...
class EnvProfile:
    ...
    def strict_numa(self) -> bool:
        ...
        return (self.os_type == OsType.LINUX and 
                self.run_context == RunContext.PRODUCTION and
                os.environ.get("VELO_STRICT_NUMA") == "1")
    ...
    def detect(cls) -> "EnvProfile":
        ...
        if pytest_running and velo_env != "ci":
            # Running inside pytest but not explicitly CI mode
