...
# Python Environment SSOT (Phase 7.3+)
# =============================================================================
# These constants define the Python environment configuration.
# Source of truth: config/constants.toml [python_environment]
#
# Used by:
#   - Velo Rust runtime (src/common/python_env.rs)
#   - Velo Python runtime (this file)
#   - Build system (build.rs)

PYTHON_REQUIRED_VERSION = "{py_required_version}"
PYTHON_VENV_PATH = "{py_venv_path}"
PYTHON_LIB_DIR_PATTERN = "{py_lib_dir_pattern}"
PYTHON_LIB_DYNLOAD_SUBDIR = "{py_lib_dynload_subdir}"
PYTHON_ENV_VARS = [{py_env_vars_py}]
"#,
        protocol_version = constants.protocol_version,
        socket_path_limit = constants.socket_path_limit,
        max_message_size = constants.max_message_size,
        ...
        build_hash = git_hash,
        python_version = constants.python_version,
        // Python Environment SSOT
        py_required_version = py_env.required_version,
        py_venv_path = py_env.venv_path,
        py_lib_dir_pattern = py_env.lib_dir_pattern,
        py_lib_dynload_subdir = py_env.lib_dynload_subdir,
        py_env_vars_py = py_env
            .env_vars
            .iter()
            .map(|s| format!("\"{}\"", s))
            .collect::<Vec<_>>()
