...
class TestV_NamingConventionAlignment:
    ...
    def test_ARCH_001_python_v_modules_exist(self):
        ...
        velo_zygote_path = Path(__file__).parents[4] / "velo_zygote"
    ...
    def test_ARCH_002_rust_v_modules_exist(self):
        ...
        src_zygote_path = Path(__file__).parents[4] / "src" / "zygote"
...
class TestCrossLayerInvariants:
    ...
    def test_INV_ARCH_002_config_ssot(self):
        ...
        settings_path = Path(__file__).parents[4] / "velo_zygote" / "settings.py"
    ...
    def test_INV_ARCH_004_protocol_compatibility(self):
        ...
        rust_test_files = [
            Path(__file__).parents[4] / "src" / "zygote" / "core_ipc.rs",
            Path(__file__).parents[4] / "src" / "zygote" / "v_fork.rs",
        ]
...
class TestPhase14AuditBenchmarks:
    ...
    def test_PERF_001_benchmark_targets_documented(self):
        ...
        rfc_path = Path(__file__).parents[4] / "docs" / "rfcs" / "0028-zygote-test-executor.md"
