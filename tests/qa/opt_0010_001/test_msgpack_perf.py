...
class TestMsgpackPerformance(unittest.TestCase):
    ...
    def test_perf_opt_001_cold_start_improvement(self):
        ...
        self.assertIn("import msgpack", source,
                     "Primary import must be msgpack")
        self.assertIn("import umsgpack", source,
                     "Fallback import must be umsgpack")
        self.assertNotIn("import json", source.split("# ============")[0],
