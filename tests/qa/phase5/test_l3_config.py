...
class TestL3Config:
    ...
    @pytest.mark.config
    def test_config_001_rebuild_flag(self, simple_project: Any, velo_binary: Any) -> None:
        """
    ...
    @pytest.mark.config
    def test_config_004_output_custom_path(self, simple_project: Any, velo_binary: Any) -> None:
        """
    ...
    def test_config_005_help_shows_options(self, simple_project: Any, velo_binary: Any) -> None:
        """
    ...
    @pytest.mark.config
    def test_config_002_no_deps_flag(self, simple_project: Any, velo_binary: Any) -> None:
        """
        CONFIG-002: --no-deps excludes dependencies
...
"""
    ...
    @pytest.mark.config
    def test_config_003_exclude_pattern(self, simple_project: Any, velo_binary: Any) -> None:
        """
        CONFIG-003: --exclude excludes modules
    ...
    @pytest.mark.config
    def test_run_fast_flag(self, simple_project: Any, velo_binary: Any) -> None:
        """
