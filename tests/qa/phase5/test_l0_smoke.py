...
class TestL0Smoke:
    ...
    @pytest.mark.smoke
    def test_smoke_002_velo_run_fast_boots(self, simple_project: Any, velo_binary: Any) -> None:
        """
        SMOKE-002: velo run --fast boots
    ...
    @pytest.mark.smoke
    def test_smoke_003_basic_import_works(self, simple_project: Any, velo_binary: Any) -> None:
        """
        SMOKE-003: Basic import works
...
class TestL0PerformanceBaseline:
    ...
    @pytest.mark.smoke
    def test_no_performance_regression(self, simple_project: Any, velo_binary: Any) -> None:
        """
