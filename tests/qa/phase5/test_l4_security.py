        ...
        if bundle_path.exists():
            ...
            try:
                ...
                if bundle_path.exists():
                    ...
                    assert "insecure" in result.stderr.lower() or \
                           "location" in result.stderr.lower() or \
    ...
    def test_sec_003_corrupted_bundle_detected(self, tmp_path, velo_binary):
        ...
        if bundle_path.exists():
            ...
            if bundle_path.exists():
                ...
                assert "corrupt" in result.stderr.lower() or \
                       "integrity" in result.stderr.lower() or \
                       "hash" in result.stderr.lower() or \
                       "blake3" in result.stderr.lower()
