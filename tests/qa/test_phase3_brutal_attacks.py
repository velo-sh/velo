...
class TestResourceExhaustion:
    ...
    def test_attack_memory_bomb(self):
        ...
        with AttackEnv() as env:
            env.create_script("memory_bomb.py", '''
# Try to allocate 1GB
try:
...
class TestOutputExtremes:
    ...
    def test_attack_huge_stdout(self):
        ...
        with AttackEnv() as env:
            env.create_script("huge_stdout.py", '''
...
''')
    ...
    def test_attack_binary_stdout(self):
        ...
        with AttackEnv() as env:
            env.create_script("binary_stdout.py", '''
import sys
...
''')
    ...
    def test_attack_mixed_stdout_stderr(self):
        ...
        with AttackEnv() as env:
            env.create_script("mixed_output.py", '''
import sys
for i in range(1000):
...
''')
    ...
    def test_attack_no_newline_flood(self):
        ...
        with AttackEnv() as env:
            env.create_script("no_newline.py", '''
import sys
...
''')
    ...
    def test_attack_sleep_forever(self):
        ...
        with AttackEnv() as env:
            env.create_script("sleep_forever.py", '''
import time
time.sleep(99999)
''')
    ...
    def test_attack_blocking_stdin(self):
        ...
        with AttackEnv() as env:
            env.create_script("block_stdin.py", '''
import sys
...
class TestSignalAttacks:
    ...
    def test_attack_ignore_sigterm(self):
        ...
        with AttackEnv() as env:
            env.create_script("ignore_sigterm.py", '''
import signal
import time
