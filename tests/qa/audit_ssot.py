...
class TestSSOTIntegrity:
    ...
    def test_graceful_shutdown_timeout_sync(self, constants_toml: dict, constants_py_values: dict):
        ...
        assert constants_py_values.get("GRACEFUL_SHUTDOWN_TIMEOUT") == constants_toml.get("graceful_shutdown_timeout"), \
    ...
    def test_security_base_env_whitelist_sync(self, constants_toml: dict, constants_py_values: dict):
        ...
        assert constants_py_values.get("SECURITY_BASE_ENV_WHITELIST") == constants_toml.get("security_base_env_whitelist"), \
