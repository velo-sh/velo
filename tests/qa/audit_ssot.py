...
class TestSSOTIntegrity:
    ...
    @pytest.fixture
    def constants_toml(self, project_root: Path) -> dict[str, Any]:
    ...
    @pytest.fixture
    def constants_py_values(self, project_root: Path) -> dict[str, Any]:
    ...
    def test_protocol_version_sync(self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]) -> None:
    ...
    def test_max_message_size_sync(self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]) -> None:
    ...
    def test_socket_path_limit_sync(self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]) -> None:
    ...
    def test_socket_startup_timeout_sync(
        self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]
    ) -> None:
    ...
    def test_graceful_shutdown_timeout_sync(
        self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]
    ) -> None:
    ...
    def test_default_port_sync(self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]) -> None:
    ...
    def test_security_base_env_whitelist_sync(
        self, constants_toml: dict[str, Any], constants_py_values: dict[str, Any]
    ) -> None:
    ...
    def test_constants_py_is_auto_generated(self, project_root: Path) -> None:
